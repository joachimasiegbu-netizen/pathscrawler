// Career Changer-only duplicate of demoCareers.js, per explicit instruction
// to keep the two data sources separate rather than adding hardSkills/
// softSkills to the shared file. This means every field below except
// hardSkills/softSkills is a byte-for-byte copy of demoCareers.js at the
// time of duplication (same ids, titles, salaries, descriptions, etc.) -
// it will silently drift out of sync with demoCareers.js on any future edit
// to that file, since nothing keeps the two in sync automatically.
const rawDemoCareers2 = [
  {
    id: 1,
...
// Career Changer skill tags, keyed by the same numeric `id` every career
// already has. Covers all 83 careers in this file, and is the pool
// CareerChangerResultsPage.tsx matches every currentJob against - no
// separate curated subset anymore, every career here is a candidate result.
const CAREER_SKILLS_BY_ID = {
  1: { hardSkills: ['programming', 'version control', 'database basics', 'debugging'], softSkills: ['problem solving', 'logical thinking', 'attention to detail', 'teamwork', 'continuous learning'] },
  2: { hardSkills: ['data analysis', 'SQL', 'Excel', 'data visualisation'], softSkills: ['analytical thinking', 'problem solving', 'attention to detail', 'communication', 'curiosity'] },
  3: { hardSkills: ['network security', 'risk assessment', 'incident response', 'troubleshooting'], softSkills: ['analytical thinking', 'attention to detail', 'calm under pressure', 'problem solving'] },
  4: { hardSkills: ['user research', 'wireframing', 'prototyping', 'Figma'], softSkills: ['empathy', 'creativity', 'communication', 'problem solving', 'collaboration'] },
  5: { hardSkills: ['troubleshooting', 'networking basics', 'ticketing systems', 'hardware repair'], softSkills: ['problem solving', 'customer service', 'patience', 'communication'] },
  6: { hardSkills: ['routing & switching', 'network security', 'troubleshooting', 'cabling standards'], softSkills: ['problem solving', 'attention to detail', 'calm under pressure', 'communication'] },
  7: { hardSkills: ['cloud platforms', 'infrastructure as code', 'system design', 'security'], softSkills: ['strategic thinking', 'problem solving', 'communication', 'leadership'] },
  8: { hardSkills: ['Python', 'machine learning', 'data pipelines', 'model deployment'], softSkills: ['problem solving', 'analytical thinking', 'continuous learning', 'attention to detail'] },
  9: { hardSkills: ['HTML/CSS/JavaScript', 'responsive design', 'APIs', 'version control'], softSkills: ['problem solving', 'creativity', 'attention to detail', 'continuous learning'] },
  10: { hardSkills: ['Unity/Unreal', 'C#', 'game design', '3D modelling'], softSkills: ['creativity', 'problem solving', 'teamwork', 'attention to detail'] },
  11: { hardSkills: ['requirements gathering', 'process mapping', 'data analysis', 'stakeholder management'], softSkills: ['communication', 'problem solving', 'analytical thinking', 'negotiation', 'organisation'] },
  12: { hardSkills: ['financial reporting', 'tax', 'auditing', 'accounting software', 'regulatory compliance'], softSkills: ['attention to detail', 'integrity', 'analytical thinking', 'organisation', 'numeracy'] },
  13: { hardSkills: ['financial planning', 'pensions', 'investments', 'regulatory compliance'], softSkills: ['communication', 'trustworthiness', 'empathy', 'analytical thinking', 'organisation'] },
  14: { hardSkills: ['project planning', 'budgeting', 'risk management', 'scheduling'], softSkills: ['leadership', 'communication', 'organisation', 'problem solving', 'time management'] },
  15: { hardSkills: ['digital marketing', 'campaign management', 'analytics', 'content strategy'], softSkills: ['creativity', 'communication', 'analytical thinking', 'adaptability', 'strategic thinking'] },
  16: { hardSkills: ['recruitment', 'employment law', 'HR systems', 'payroll basics'], softSkills: ['communication', 'empathy', 'discretion', 'organisation', 'conflict resolution'] },
  17: { hardSkills: ['sales forecasting', 'CRM software', 'territory planning', 'pipeline management'], softSkills: ['leadership', 'communication', 'negotiation', 'motivation', 'target driven'] },
  18: { hardSkills: ['business analysis', 'strategy', 'data modelling', 'presentation'], softSkills: ['communication', 'problem solving', 'analytical thinking', 'adaptability', 'confidence'] },
  19: { hardSkills: ['financial modelling', 'valuation', 'Excel', 'market analysis'], softSkills: ['analytical thinking', 'resilience', 'communication', 'attention to detail'] },
  20: { hardSkills: ['risk assessment', 'policy terms', 'data analysis', 'regulatory compliance'], softSkills: ['analytical thinking', 'attention to detail', 'decision making', 'communication'] },
  21: { hardSkills: ['clinical diagnosis', 'patient examination', 'prescribing', 'medical records'], softSkills: ['empathy', 'communication', 'resilience', 'decision making'] },
  22: { hardSkills: ['clinical procedures', 'patient assessment', 'medication', 'medical records'], softSkills: ['empathy', 'communication', 'resilience', 'attention to detail', 'teamwork'] },
  23: { hardSkills: ['emergency care', 'trauma assessment', 'drug administration', 'driving'], softSkills: ['calm under pressure', 'decision making', 'communication', 'resilience'] },
  24: { hardSkills: ['dispensing', 'drug knowledge', 'clinical checks', 'patient counselling'], softSkills: ['attention to detail', 'communication', 'integrity', 'calm under pressure'] },
  25: { hardSkills: ['manual therapy', 'exercise prescription', 'assessment', 'rehabilitation'], softSkills: ['empathy', 'communication', 'patience', 'problem solving'] },
  26: { hardSkills: ['assessment', 'adaptation design', 'rehabilitation planning', 'equipment prescription'], softSkills: ['empathy', 'creativity', 'problem solving', 'communication', 'patience'] },
  27: { hardSkills: ['dental procedures', 'radiography', 'infection control', 'restoration'], softSkills: ['manual dexterity', 'communication', 'empathy', 'attention to detail'] },
  28: { hardSkills: ['psychological assessment', 'research methods', 'case formulation', 'data analysis'], softSkills: ['empathy', 'communication', 'analytical thinking', 'patience', 'resilience'] },
  29: { hardSkills: ['imaging technology', 'radiation safety', 'patient positioning', 'image analysis'], softSkills: ['attention to detail', 'communication', 'technical aptitude', 'empathy'] },
  30: { hardSkills: ['antenatal care', 'delivery assistance', 'neonatal care', 'emergency procedures'], softSkills: ['empathy', 'communication', 'calm under pressure', 'resilience'] },
  31: { hardSkills: ['structural analysis', 'AutoCAD', 'project management', 'materials science'], softSkills: ['problem solving', 'analytical thinking', 'teamwork', 'attention to detail'] },
  32: { hardSkills: ['CAD', 'manufacturing processes', 'materials knowledge', 'tool use'], softSkills: ['problem solving', 'analytical thinking', 'teamwork', 'attention to detail'] },
  33: { hardSkills: ['circuit design', 'power systems', 'testing', 'safety standards'], softSkills: ['problem solving', 'analytical thinking', 'attention to detail', 'teamwork'] },
  34: { hardSkills: ['aerodynamics', 'CAD', 'structural analysis', 'materials science'], softSkills: ['problem solving', 'attention to detail', 'teamwork', 'analytical thinking'] },
  35: { hardSkills: ['process design', 'thermodynamics', 'safety', 'reaction engineering'], softSkills: ['problem solving', 'analytical thinking', 'attention to detail', 'safety awareness'] },
  36: { hardSkills: ['CAD', 'building regulations', 'structural design', '3D modelling'], softSkills: ['creativity', 'problem solving', 'communication', 'attention to detail'] },
  37: { hardSkills: ['cost estimation', 'contract management', 'valuation', 'procurement'], softSkills: ['numeracy', 'attention to detail', 'negotiation', 'organisation', 'communication'] },
  38: { hardSkills: ['CAD software', 'technical drawing', 'measurement', 'design standards'], softSkills: ['attention to detail', 'problem solving', 'communication', 'patience'] },
  39: { hardSkills: ['Adobe Creative Suite', 'typography', 'branding', 'layout'], softSkills: ['creativity', 'communication', 'attention to detail', 'time management'] },
  40: { hardSkills: ['Premiere Pro', 'colour grading', 'sound design', 'motion graphics'], softSkills: ['creativity', 'attention to detail', 'patience', 'time management'] },
  41: { hardSkills: ['camera operation', 'lighting', 'editing', 'composition'], softSkills: ['creativity', 'communication', 'attention to detail', 'patience'] },
  42: { hardSkills: ['After Effects', '2D/3D animation', 'storyboarding', 'character design'], softSkills: ['creativity', 'patience', 'attention to detail', 'storytelling'] },
  43: { hardSkills: ['copywriting', 'editing', 'SEO', 'research'], softSkills: ['creativity', 'communication', 'time management', 'adaptability'] },
  44: { hardSkills: ['content creation', 'analytics', 'scheduling tools', 'platform algorithms'], softSkills: ['creativity', 'communication', 'adaptability', 'trend awareness'] },
  45: { hardSkills: ['budgeting', 'scheduling', 'production management', 'contracts'], softSkills: ['leadership', 'organisation', 'communication', 'problem solving'] },
  46: { hardSkills: ['lesson planning', 'curriculum delivery', 'assessment', 'classroom management'], softSkills: ['communication', 'patience', 'empathy', 'organisation'] },
  47: { hardSkills: ['lesson planning', 'subject expertise', 'assessment', 'classroom management'], softSkills: ['communication', 'patience', 'organisation', 'presentation'] },
  48: { hardSkills: ['classroom support', 'lesson preparation', 'behaviour support', 'record keeping'], softSkills: ['patience', 'communication', 'empathy', 'teamwork'] },
  49: { hardSkills: ['curriculum design', 'subject expertise', 'academic writing', 'assessment'], softSkills: ['communication', 'presentation', 'critical thinking', 'mentoring'] },
  50: { hardSkills: ['careers guidance frameworks', 'labour market knowledge', 'assessment', 'case management'], softSkills: ['communication', 'empathy', 'patience', 'organisation'] },
  61: { hardSkills: ['CI/CD', 'cloud platforms', 'automation', 'monitoring'], softSkills: ['problem solving', 'collaboration', 'continuous learning', 'adaptability'] },
  62: { hardSkills: ['SQL', 'database design', 'backup & recovery', 'performance tuning'], softSkills: ['attention to detail', 'problem solving', 'organisation', 'calm under pressure'] },
  63: { hardSkills: ['Solidity', 'smart contracts', 'cryptography', 'distributed systems'], softSkills: ['problem solving', 'continuous learning', 'attention to detail', 'analytical thinking'] },
  64: { hardSkills: ['penetration testing', 'vulnerability assessment', 'network security', 'scripting'], softSkills: ['analytical thinking', 'attention to detail', 'integrity', 'problem solving'] },
  65: { hardSkills: ['evidence recovery', 'forensic tools', 'chain of custody', 'reporting'], softSkills: ['attention to detail', 'integrity', 'analytical thinking', 'patience'] },
  66: { hardSkills: ['cloud security', 'identity management', 'risk assessment', 'monitoring'], softSkills: ['analytical thinking', 'attention to detail', 'calm under pressure', 'communication'] },
  67: { hardSkills: ['monitoring', 'automation', 'incident response', 'cloud platforms'], softSkills: ['problem solving', 'calm under pressure', 'collaboration', 'continuous learning'] },
  68: { hardSkills: ['Swift/Kotlin', 'APIs', 'mobile UX', 'app deployment'], softSkills: ['problem solving', 'creativity', 'attention to detail', 'continuous learning'] },
  69: { hardSkills: ['requirements analysis', 'process modelling', 'SQL', 'documentation'], softSkills: ['analytical thinking', 'communication', 'problem solving', 'attention to detail'] },
  70: { hardSkills: ['technical documentation', 'API docs', 'editing', 'information architecture'], softSkills: ['communication', 'attention to detail', 'curiosity', 'organisation'] },
  71: { hardSkills: ['data entry', 'spreadsheets', 'record keeping', 'typing accuracy'], softSkills: ['attention to detail', 'reliability', 'organisation', 'time management'] },
  72: { hardSkills: ['scheduling', 'email management', 'data entry', 'Microsoft Office'], softSkills: ['organisation', 'communication', 'reliability', 'time management'] },
  73: { hardSkills: ['personal care', 'mobility assistance', 'medication prompting', 'documentation'], softSkills: ['empathy', 'patience', 'communication', 'reliability', 'resilience'] },
  74: { hardSkills: ['accounting software', 'reconciliation', 'invoicing', 'financial records'], softSkills: ['attention to detail', 'organisation', 'integrity', 'numeracy'] },
  75: { hardSkills: ['CRM systems', 'complaint handling', 'product knowledge', 'data entry'], softSkills: ['communication', 'patience', 'listening', 'customer service'] },
  76: { hardSkills: ['content writing', 'SEO', 'research', 'editing'], softSkills: ['creativity', 'communication', 'time management', 'curiosity'] },
  77: { hardSkills: ['food safety', 'booking systems', 'cash handling', 'service standards'], softSkills: ['customer service', 'multitasking', 'communication', 'calm under pressure'] },
  79: { hardSkills: ['treatment techniques', 'product knowledge', 'hygiene standards', 'salon software'], softSkills: ['customer service', 'creativity', 'attention to detail', 'listening'] },
  82: { hardSkills: ['animal handling', 'feeding & welfare', 'basic health checks', 'record keeping'], softSkills: ['empathy', 'patience', 'physical stamina', 'observation'] },
  83: { hardSkills: ['crop/livestock management', 'machinery operation', 'land management', 'health & safety'], softSkills: ['physical stamina', 'problem solving', 'independence', 'resilience'] },
  84: { hardSkills: ['plant science', 'soil management', 'pest control', 'propagation'], softSkills: ['patience', 'physical stamina', 'attention to detail', 'practical skills'] },
  85: { hardSkills: ['animal nursing', 'anaesthesia support', 'laboratory work', 'surgical assistance'], softSkills: ['empathy', 'communication', 'attention to detail', 'physical stamina'] },
  86: { hardSkills: ['food preparation', 'kitchen management', 'menu planning', 'health & safety'], softSkills: ['creativity', 'time management', 'teamwork', 'calm under pressure'] },
  87: { hardSkills: ['budgeting', 'vendor management', 'logistics', 'booking systems'], softSkills: ['organisation', 'communication', 'problem solving', 'calm under pressure', 'multitasking'] },
  88: { hardSkills: ['training programme design', 'performance analysis', 'first aid', 'nutrition basics'], softSkills: ['motivation', 'communication', 'leadership', 'enthusiasm'] },
  89: { hardSkills: ['tool use', 'blueprint reading', 'health & safety', 'measurement'], softSkills: ['physical stamina', 'teamwork', 'reliability', 'attention to detail'] },
  90: { hardSkills: ['incident reporting', 'investigation basics', 'public order', 'first aid'], softSkills: ['calm under pressure', 'communication', 'judgment', 'resilience', 'teamwork'] },
  91: { hardSkills: ['research methods', 'data analysis', 'laboratory techniques', 'academic writing'], softSkills: ['analytical thinking', 'curiosity', 'attention to detail', 'patience'] },
  92: { hardSkills: ['legal research', 'contract review', 'case law', 'compliance'], softSkills: ['analytical thinking', 'communication', 'attention to detail', 'integrity'] },
  93: { hardSkills: ['electrical systems', 'installation standards', 'project planning', 'site assessment'], softSkills: ['problem solving', 'attention to detail', 'teamwork', 'analytical thinking'] },
  94: { hardSkills: ['inventory management', 'sales forecasting', 'scheduling', 'budgeting'], softSkills: ['leadership', 'problem solving', 'negotiation', 'decision making', 'motivation'] },
  95: { hardSkills: ['data entry', 'scheduling', 'Microsoft Office', 'filing systems'], softSkills: ['organisation', 'communication', 'reliability', 'time management'] },
  96: { hardSkills: ['news writing', 'interviewing', 'fact-checking', 'editing'], softSkills: ['curiosity', 'communication', 'resilience', 'time management'] },
}
const DEFAULT_SKILLS = { hardSkills: [], softSkills: [] }

// Normalize subject ids to match `subjects.json` ids and fix common typos
const demoCareers2 = rawDemoCareers2.map((career) => ({
  ...career,
  ...
  // Career Changer additions - not present on demoCareers.js's Career type.
  hardSkills: (CAREER_SKILLS_BY_ID[career.id] || DEFAULT_SKILLS).hardSkills,
  softSkills: (CAREER_SKILLS_BY_ID[career.id] || DEFAULT_SKILLS).softSkills,
}))
